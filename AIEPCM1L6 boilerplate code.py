...
def recommend_movies(genre = None, mood = None, rating = None, top_n = 5):
    ...
    for idx,row in filtered_df.iterrows():
        ...
        if len(recommendations) == top_n:
            break
    return recommendations if recommendations else "No suitbale movie recommendations found ."
...
def handle_ai(name):
    ...
    #genres in a single line
    print(Fore.GREEN+"Availible Genres: ", end = "")
    ...
    while True:
        ...
        try:
            ...
            if 7.6 <= rating <= 9.3:
                break
            print(Fore.RED + "Rating out of range. Try again /n")
        except ValueError:
            print(Fore.RED + "Invalid input. Try Again. /n")
